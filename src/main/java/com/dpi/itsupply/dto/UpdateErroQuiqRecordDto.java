...
public record UpdateErroQuiqRecordDto(@NotNull Integer id, @NotNull LocalDate dataPadronizada, @NotNull Mes mes,
                                      @NotNull Integer ano,
                                      @NotNull LocalDateTime dataPedido, @NotNull LocalDateTime dataErro,
                                      @NotNull Plataforma plataforma, @NotNull Short empresa,
